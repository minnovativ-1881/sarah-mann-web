...
const bedWunsch: Test = {
  ...
  ergebnisse: [
    ...
    {
      key: "teils",
      name: "Dein Gespür ist da, die Linie noch nicht",
      unter: "Vier oder fünf Treffer.",
      text: "Du erkennst die klaren Fälle sicher, und in der Mitte wird es unscharf. Das ist der häufigste Stand überhaupt, und er hat einen Grund: In fast allen Ratgebern heißt beides Bedürfnis. Wer diese Unterscheidung nie gelernt hat, kann sie im Alltag auch nicht treffen und landet fast zwangsläufig in dem Gefühl, dass Bedürfnisorientierung uferlos ist. Genau hier wird es wieder handhabbar.",
      schritte: [
        "Merk dir die eine Prüffrage: Was bleibt, wenn ich es nicht erfülle? Ein Mangel oder eine Enttäuschung?",
        "Nimm dir für diese Woche eine wiederkehrende Situation vor und entscheide einmal in Ruhe, was sie ist. Danach musst du im Moment nicht mehr abwägen.",
        "Rechne nicht damit, dass es sofort leichter wird. Die Unterscheidung ist schnell verstanden und braucht ein paar Wochen, bis sie im Alltag sitzt.",
      ],
      von: 4,
      bis: 5,
    },
    {
      ...
      text: "Das ist überhaupt kein schlechtes Zeichen, im Gegenteil, und es sagt nichts über deine Zuwendung. Die meisten Eltern haben nie gelernt, hier zu unterscheiden, weil in fast allen Ratgebern beides Bedürfnis heißt. Genau deshalb fühlt sich bedürfnisorientierte Erziehung so oft uferlos an: Wer jeden Wunsch als Bedürfnis liest, kann irgendwann nichts mehr ablehnen, ohne ein schlechtes Gewissen zu haben. Mit dieser einen Unterscheidung wird vieles wieder handhabbar, und zwar ziemlich schnell.",
      schritte: [
        "Lies die Auflösungen unten in Ruhe durch. Sie sind der eigentliche Inhalt dieses Tests.",
        "Nimm dir für den Anfang nur zwei Kategorien vor: Schlaf und Sicherheit sind fast immer Bedürfnisse, Süßes und Bildschirm fast immer Wünsche.",
        "Erlaub dir, bei einem Wunsch Nein zu sagen, ohne es zu begründen. Ein Kind braucht keine Begründung, es braucht eine verlässliche Antwort.",
      ],
      von: 0,
      bis: 3,
    },
