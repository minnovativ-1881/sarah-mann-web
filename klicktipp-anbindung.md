...
Alle sieben Tests sind eingerichtet, Schlüssel und HTML-Feld liegen als
...
| Reizprofil-Test | field1001171 |

Die E-Mail-Vorlagen dazu liegen in `email-vorlagen-tests.md`.

Der Reizprofil-Test ist technisch fertig eingerichtet. Der Test selbst wird
gerade noch geschrieben, sobald er live ist, trägt er sofort ein.
